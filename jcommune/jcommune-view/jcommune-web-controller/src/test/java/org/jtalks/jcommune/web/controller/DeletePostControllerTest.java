...
public class DeletePostControllerTest {
    ...
    public void confirmTest(){     
        long topicId = 1;
        long postId = 5;
        ModelAndView actualMav = deletePostController.confirm(topicId, postId);
    ...
    public void deleteTest(){
        long topicId = 1;
        long postId = 5;
        ModelAndView actualMav = deletePostController.delete(topicId, postId);
        assertViewName(actualMav, "redirect:/topics/" + topicId + ".html");
