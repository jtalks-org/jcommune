...
UPDATE CONTACT_TYPE SET MASK='AIM' WHERE TYPE_ID = 14;
UPDATE CONTACT_TYPE SET MASK='MSN' WHERE TYPE_ID = 15;
UPDATE CONTACT_TYPE SET MASK='YIM' WHERE TYPE_ID = 16;
