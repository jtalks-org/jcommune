...
/*
* This script contains custom events
*/
(function ($) {
    $.event.special.valuechange = {
        setup: function () {
            $(this).bind('keyup.valuechange', $.event.special.valuechange.handler);
            $(this).bind('cut.valuechange input.valuechange', $.event.special.valuechange.delayedHandler);
            // for IE
