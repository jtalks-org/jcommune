...
!function (e) {
    ...
    t.prototype = {constructor: t, init: function (t, n, r) {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            e.detach().css({top: 0, left: 0, display: "block"}).insertAfter(this.$element), n = this.getPosition(t), r = e[0].offsetWidth, i = e[0].offsetHeight;
            if (this.$element && this.$tip) {
                var targ = this.$element, wind = $(window), extraTiplength = r / 2 - targ.width() / 2;
                if (this.options.cls) {
                ...
                } else if (targ.offset().left >= extraTiplength && targ.offset().top >= i && wind.width() - targ.offset().left >= extraTiplength) {
                    s = 'top';
                } else if (targ.offset().left >= extraTiplength && wind.height() - targ.offset().top - targ.height() > i && wind.width() - targ.offset().left >= extraTiplength) {
                    s = 'bottom';
                } else if (targ.offset().left < extraTiplength) {
                    s = 'right'
                } else {
                    s = 'left'
                }
