...
!function (e) {
    ...
    n.prototype = {constructor: n, toggle: function (t) {
        ...
        e.stopPropagation()
    }).on("click.dropdown.data-api touchstart.dropdown.data-api", t, n.prototype.toggle).on('touchstart.dropdown', '.dropdown-menu',function (e) {
        e.stopPropagation()
    ...
    t.prototype = {constructor: t, init: function (t, n, r) {
        ...
        if (this.hasContent() && this.enabled) {
            e = this.tip(), this.setContent(), this.options.animation && e.addClass("fade");
            if (this.$element && this.$tip) {
                var targ = this.$element, wind = $(window), tiplength = this.$tip.text().length * 5, tipheight = 20;
                if (this.options.cls) {
                    e.addClass(this.options.cls)
                }
                ;
                if (this.options.placement && this.options.placement != '') {
                    s = typeof this.options.placement == "function" ? this.options.placement.call(this, e[0], this.$element[0]) : this.options.placement
                } else if (targ.offset().left >= tiplength && targ.offset().top >= tipheight && wind.width() - targ.offset().left >= tiplength) {
                    s = 'top';
                } else if (targ.offset().left >= tiplength && wind.height() - targ.offset().top - targ.height() < tipheight && wind.width() - targ.offset().left >= tiplength) {
                    s = 'bottom';
                } else if (targ.offset().left < tiplength) {
                    s = 'right'
                } else {
                    s = 'left'
                }
            ...
            t = /in/.test(s), e.detach().css({top: 0, left: 0, display: "block"}).insertAfter(this.$element), n = this.getPosition(t), r = e[0].offsetWidth, i = e[0].offsetHeight;
            var width = n.width;
            if (this.$element.css('max-width') && width > parseInt(this.$element.css('max-width'))) {
                width = parseInt(this.$element.css('max-width'));
            }
            ;
            switch (t ? s.split(" ")[1] : s) {
                case"bottom":
                    o = {top: n.top + n.height, left: n.left + width / 2 - r / 2};
                    break;
                case"top":
                    o = {top: n.top - i, left: n.left + width / 2 - r / 2};
                    break;
                case"left":
                    o = {top: n.top + n.height / 2 - i / 2, left: n.left - r};
                    break;
                case"right":
                    o = {top: n.top + n.height / 2 - i / 2, left: n.left + width}
            }
    ...
    }, e.fn.tooltip.Constructor = t, e.fn.tooltip.defaults = {animation: !0, placement: "", selector: !1, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover", title: "", delay: 0, html: !1}
}(window.jQuery), !function (e) {
    "use strict";
    var t = function (e, t) {
