    ...
    t.prototype = {constructor: t, init: function (t, n, r) {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (this.$element && this.$tip) {
                var targ = this.$element, wind = $(window), tiplength = this.$tip.text().length / 2 * 10, tipheight = 20;
                if (this.options.cls) {
                ...
                if (this.options.placement && this.options.placement != '') {
                    ...
                    s = 'top';
                } else if (targ.offset().top < 20) {
                    s = 'bottom';
                } else if (targ.offset().left < tiplength) {
                    s = 'right'
                } else if (wind.width() - targ.offset().left < tiplength) {
                    s = 'left'
                }
                ;
            }
