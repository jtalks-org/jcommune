    ...
    <%-- Language chooser --%>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu lang-menu">
                <li id='lang-en'>
                    <a href="href=${pageContext.request.contextPath}/lang=en" onclick="window.location = getLanguageLink('en')">
                ...
                <li id='lang-ru'>
                    <a href="${pageContext.request.contextPath}/lang=ru" <%--onclick="window.location = getLanguageLink('ru')"--%>>
                ...
                <li id='lang-uk'>
                    <a href="${pageContext.request.contextPath}/lang=uk" onclick="window.location = getLanguageLink('uk')">
