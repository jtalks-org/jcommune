...
<c:choose>
  ...
  <c:otherwise>
    ...
    <c:if test="${fn:contains(uriString, 'topics') and fn:contains(uriString, 'new')}">
      <script src="${pageContext.request.contextPath}/resources/javascript/app/pollNewTopic.js"></script>
    </c:if>
