...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/admin/icon/ico?v=${pageContext.session.lastAccessedTime}"/>
  <link rel="icon" type="image/png" href="${pageContext.request.contextPath}/admin/icon/png?v=${pageContext.session.lastAccessedTime}"/>
