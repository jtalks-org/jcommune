        ...
        <c:choose>
            <c:when test="${!(empty section.branches)}">
                ...
                <tr>
                    ...
                    <th class="topics-posts forum-posts-view-header"><spring:message
                            code="label.branch.header.topics_posts"/></th>
                    ...
                    <tr>
                        ...
                        <td class="topics-posts">
                            ...
                            <spring:message code="label.section.header.messages"/>: <span
                                class='test-posts-count'><c:out value="${branch.postCount}"/></span>
                        </td>
                        <td class="latest-by">
