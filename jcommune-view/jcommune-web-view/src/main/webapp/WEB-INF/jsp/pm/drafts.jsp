  ...
  <div class="row-fluid upper-pagination forum-pagination-container">
    <div class="span11">
      <div class="pagination pull-right forum-pagination">
        <ul>
          <jtalks:pagination uri="" page="${draftsPage}" numberLink="3"/>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="span9">
      ...
      <table class="table table-bordered table-condensed">
        ...
        <tr>
          ...
          <th class="pm_header_info"><i class="icon-white-user margin-right-big"></i>
            <spring:message code="label.pm.recipient"/></th>

          <th><i class="icon-white-font margin-right-big"></i> <spring:message code="label.pm.title"/></th>

          <th class="pm_sending_date"><i class="icon-white-calendar margin-right-big"></i>
        ...
        <c:choose>
          <c:when test="${!(empty draftsPage.content)}">
            <c:forEach var="pm" items="${draftsPage.content}">
