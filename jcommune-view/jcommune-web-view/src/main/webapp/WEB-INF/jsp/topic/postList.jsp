...
<c:if test="${isFirstPost && (topic.type.codeReview)}">
      ...
      <div class="btn-toolbar post-btn-toolbar">
        <div class="btn-group">
          ...
          <sec:authorize access="isAuthenticated()">
            ...
            <c:if test='${userId == post.userCreated.id && !topic.type.codeReview}'>
        ...
        <div class="btn-group">
          ...
          <c:if test='${(!topic.closed || hasCloseTopicPermission) && !topic.type.codeReview}'>
            <jtalks:hasPermission targetId='${topic.branch.id}' targetType='BRANCH'
