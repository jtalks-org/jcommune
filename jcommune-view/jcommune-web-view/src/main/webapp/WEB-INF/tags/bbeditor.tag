...
<%@ taglib prefix="spring" uri="http://www.springframework.org/tags" %>
        ...
        <div class="btn-toolbar">
            ...
            <div class='btn-group'>
                <a id="format_left" class="btn" accesskey="left" name="format_left" onclick="doClick('left');" title="Align left">
                    <i class="icon-align-left"></i>
                </a>
                <a id="format_center" class="btn" accesskey="c" name="format_center" onclick="doClick('center');" title="Align center">
            ...
            <div class='btn-group'>
                <a href="" class='btn' onclick="closeTags();return false;" title='<spring:message code="label.answer.close_tags"/>'>[/..]</a>
    ...
    <div class='control-group'>
            ...
            <span id="editorBBCODEdiv">
                ...
                <textarea id="tbMsg" name="${bodyParameterName}" style="width:100%;height: 350px" placeholder="Topic content"><c:out
