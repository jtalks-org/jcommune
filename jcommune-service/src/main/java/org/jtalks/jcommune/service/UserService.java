...
public interface UserService extends EntityService<JCUser> {
    ...
    /**
     * Performs the following: 1. Alters the password for this user to the random string 2. Sends an e-mail with new
     * password to this address to notify user
     * <p/>
    ...
    /**
     * Activates user account based on uuid passed. We use UUID's to be sure activation link cannot be autogenerated
     * from username.
     *
    ...
    /**
     * This method will be called automatically every hour to check if there are expired user accounts to be deleted.
     * User account is expired if it's created, but not activated for a day or more.
     */
