...
/**
 * Serves for user authentication,registration and activation.
 *
...
public interface Authenticator {
     ...
     * @throws UserTriesActivatingAccountAgainException if user tries to activate account for the second time
     */
